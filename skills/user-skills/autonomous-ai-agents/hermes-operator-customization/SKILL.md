...
- `references/curator-model-routing.md` — curator model-routing lesson: built-in Skill Curator vs no-agent memory-curator cron, `xhigh` as highest Hermes reasoning label, and why native DeepSeek is preferred for guaranteed max-thinking payloads.
